...
public class RepeatingImageButton extends ImageButton {
   ...
   // 在自定义View中，都是先写它的三个构造函数
    ...
    public boolean performLongClick() {
    	Log.d("RepeatingImageButton", "RepeatingImageButton----performLongClick");
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
        	Log.d("RepeatingImageButton", "RepeatingImageButton----onTouchEvent-ACTION_UP");
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_ENTER:
            	Log.d("RepeatingImageButton", "RepeatingImageButton----onKeyDown");
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_ENTER:
            // remove the repeater, but call the hook one more time
        	Log.d("RepeatingImageButton", "RepeatingImageButton----onKeyUp");
            removeCallbacks(mRepeater);
            if (mStartTime != 0) {
                doRepeat(true);
                mStartTime = 0;
    ...
    private Runnable mRepeater = new Runnable() {
        public void run() {
            doRepeat(false);
            if (isPressed()) {
            	Log.d("RepeatingImageButton", "RepeatingImageButton----isPressed");
    ...
    public interface RepeatListener {
         ...
         * @param duration The number of milliseconds the button has been pressed so far.按下的时间长度
