...
import com.wedesign.music.util.SharedPreferencesCompat;
...
public class MediaPlaybackService extends Service {
    ...
    private int mShuffleMode = SHUFFLE_NONE;             //随机循环播放模式
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            LogUtil.i(TAG,"mIntentReceiver.onReceive " + action + " / " + cmd);
...
//            }
    ...
    public void onCreate() {
        super.onCreate();
    	Log.d("lixuan", "MediaPlaybackService--- onCreate()---服务创建");
...
//            ed.apply();
    ...
    /**
     * Starts playback of a previously opened file.     playback:播放
     */
    public void play() {
    ...
    private void updateNotification() {
        ...
        status.icon = R.drawable.icon_notify_music;
        status.contentIntent = PendingIntent.getActivity(this, 0,
                new Intent("com.wedesign.music.PLAYBACK_VIEWER")
...
//                Integer pos = mHistory.remove(histsize - 1);
    ...
    private class MultiPlayer {
        ...
        public void start() {
            LogUtil.i(TAG, ""+new Exception("MultiPlayer.start called"));
        ...
        public long duration() {
            return mCurrentMediaPlayer.getDuration();      //MediaPlayer取得音视频文件总时长
        }
